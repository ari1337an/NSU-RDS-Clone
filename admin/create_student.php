<?php 
    ...
    if(isset($_POST['name']) && isset($_POST['id']) && isset($_POST['fathers_name']) && isset($_POST['mothers_name']) && isset($_POST['password']) && isset($_POST['DOB']) &&  isset($_POST['dept']) &&  isset($_POST['degree']) && isset($_POST['credits']) &&  isset($_POST['cgpa']) && isset($_POST['nid']) &&  isset($_POST['phone']) && isset($_POST['birth_reg_no']) && isset($_POST['gender']) && isset($_POST['citizenship'])){
        ...
        $result = $APP_DB->query("SELECT count(*) as count FROM students WHERE username='$name';");
        $cnt = $result->fetch_object()->count;

        if($cnt == 0 && ctype_digit($phone) && ctype_digit($NID) && ctype_digit($birth_reg_no)){

            $query = "INSERT INTO students(USERNAME, PASSWORD) VALUES ('$id','$pass')";
            $query2 = "INSERT INTO student_profile(id, name, fathers_name, mothers_name, department_name, degree, credits, cgpa, phone_number, nid, birth_reg_no, dob, gender, citizenship) VALUES ('$id','$name','$fathers_name','$mothers_name','$dept','$degree','$credits','$cgpa','$phone','$NID','$birth_reg_no','$DOB','$gender','$citizenship')";
...
<body>
    ...
    <div class="container_panel">
        ...
        <input type="text" name="birth_reg_no" required><br>
